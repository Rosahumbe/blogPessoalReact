    ...
    return (
        <Container maxWidth="sm" className="topo">
            <form onSubmit={onSubmit} >
                ...
                <TextField value={postagem.texto}  onChange={(e: ChangeEvent<HTMLInputElement>) => updatedPostagem(e)} id="texto" label="Texto" name="texto" multiline rows={5} variant="outlined" margin="normal" fullWidth />
